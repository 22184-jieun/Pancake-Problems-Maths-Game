...
class Difficulty_Select():
    ...
    def __init__(self):
        ...
        self.chara = ""
        self.easy_button = Buttons2(350,100,160,50,"Easy", (230,188,140))
        self.med_button = Buttons2(550,100,160,50,"Medium", (230,188,140))
        self.hard_button = Buttons2(750,100,160,50,"Hard", (230,188,140))
        ...
        self.boy_sprite = pygame.transform.scale(self.boy_sprite, (int(self.boy_sprite.get_width()/5),int(self.boy_sprite.get_height()/5)))

        self.cat_sprite = pygame.image.load('Assets/catspr_norm@3x.png').convert_alpha()
        self.cat_sprite = pygame.transform.scale(self.cat_sprite, (int(self.cat_sprite.get_width()/5),int(self.cat_sprite.get_height()/5)))
    ...
    def draw(self, surface):
        ...
        pygame.draw.rect(screen,(209, 162, 109),(350,110,160,50),border_radius=12)
        pygame.draw.rect(screen,(209, 162, 109),(550,110,160,50),border_radius=12)
        pygame.draw.rect(screen,(209, 162, 109),(750,110,160,50),border_radius=12)
        ...
        if self.chara == "girl":
            screen.blit(self.girl_sprite,(-50,100))
        
        elif self.chara == "boy":
            screen.blit(self.boy_sprite,(-50,100))
        
        elif self.chara == "cat":
            screen.blit(self.cat_sprite,(-50,100))

        screen.blit(self.speech_bubble,(350,100))

        screen.blit(sub_font_sml.render(self.warning_text, True, (158, 109, 63)),(420 ,50))
    ...
    def handle_event(self, event):
        ...
        if self.play_button.is_clicked(event):
            if self.difficulty_choice != "":
                ...
                self.warning_text = "You have not selected a difficulty."
        return None
